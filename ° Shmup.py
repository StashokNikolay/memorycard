...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("playerShip1_orange.png")    #ДОБАВИЛА
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("meteorBrown_med1.png")   #ДОБАВИЛА
        self.rect = self.image.get_rect()
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("laserRed16.png")  #ДОБАВИЛА
        self.rect = self.image.get_rect()
        self.rect.bottom = y
        self.rect.centerx = x
        self.speedy = -10
